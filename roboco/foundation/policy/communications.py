...
# (note + evidence only — they own dedicated chat pages, not agent A2A), plus
# the auditor and pr_reviewer. A DM to any of these is a black hole — nothing on
# the other end can read or answer it.
