...
``cloud_auth_enabled`` are armed (see
``roboco.api.app._mount_telegram_miniapp_auth``, mirroring
``roboco.api.auth.routes.mount_cloud_auth``'s conditional mount) —
...
# ==========================================================================
# Mini App sign-in — public, pre-auth. Conditionally mounted by
# ``roboco.api.app._mount_telegram_miniapp_auth`` (mirrors
# ``roboco.api.auth.routes.mount_cloud_auth``'s conditional mount).
# ==========================================================================
