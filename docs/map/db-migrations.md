...
>
> PR #640 (2026-07-21) stripped the Telegram backend surfaces: migration `074_telegram_credentials.py` was removed and `075_company_goals_company_name` was relinked to `073_project_environments` as its `down_revision`. The chain remains linear (001→073→075→076).
